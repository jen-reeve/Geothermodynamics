...
$dU=(\frac{\partial U}{\partial S})_{V,n}dS+(\frac{\partial U}{\partial V})_{S,n}dV+(\frac{\partial U}{\partial n_1})_{S,V,n!=n_1}dn_1+...$

Define a new intensive variable of chemical potential of component: $\mu_i=(\frac{\partial U}{\partial n_i})_{S,V,n!=n_i}$

$dU=Tds-PdV+\mu_1dn_1+\mu_2dn_2+\mu_3dn_3+...+\mu_cdn_c=TdS-PdV+\Sigma^c_{i=1}\mu_idn_i$
...
$U(S,V,n_i)=TS-PV+\Sigma^c_{i=1}\mu_in_i$

for 1 component (pure substance) varies in abundance not composition: $U=TS-PV+\Sigma\mu_in_i$
...
Solution phase of multicomponent system: divide by $\Sigma^c_{i=1}n_i$

$\bar{U}=T\bar{S}-P\bar{V}+\Sigma^c_{i=1}\mu_ix_i$
...
example: $\mu_{\ch{H20}$ the numerical value will be different for steam versus ice
